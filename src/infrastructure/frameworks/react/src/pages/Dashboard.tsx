            ...
            {isAdmin && (
              <div className="p-6 bg-gray-800 rounded-lg shadow-lg md:col-span-2">
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                  ...
                  <div className="flex items-center p-6 space-x-6 bg-blue-700 rounded-lg lg:col-span-2">
                    ...
                    <div>
                      <p className="text-3xl font-bold text-white">{stats.totalBikes}</p>
                      <p className="text-gray-300">Total Motos</p>
                    </div>
                  </div>
                  
                  <div className="flex items-center p-6 space-x-6 bg-yellow-700 rounded-lg lg:col-span-2">
                    ...
                    <div>
                      <p className="text-3xl font-bold text-white">{stats.activeMaintenance}</p>
